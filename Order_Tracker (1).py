...
class OrderWindow(tk.Toplevel):
    def __init__(self, master = None):
        ...
        #form widgets
        order_id_label = tk.Label(form_frame, text='Order ID', bg='gold')
        order_id_label.pack()
    ...
    #takes order data and uses pandas to add to an excel workbook, data validation for requiring all fields
    def save_order(self):
